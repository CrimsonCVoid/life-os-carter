 ...
 * live. Tap → opens the full set-logger sheet. Pinned just above the
 * BottomNav on mobile, top-right floating chip on desktop.
 */
export function ActiveWorkoutBanner() {
  ...
  if (pathname === "/signin" || pathname.startsWith("/onboarding")) return null;
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "rounded-2xl border border-[var(--color-stroke-strong)] bg-[color:color-mix(in_srgb,var(--color-card)_92%,transparent)] backdrop-blur",
